...
const App = () => {
  ...
  return (
    <div className="calculator">
      ...
      <footer>
        <p>DEVELOPED BY DINAGARAN JOHNY S</p>
        <p>Reg No: 2122232200020</p> 
      </footer>
...
body {
  ...
  align-items: center;
  height: 100vh;
  background-color: #c4dc87;
  margin: 0;
}

.calculator {
  background-color: #19bac08a;
  padding: 20px;
  border-radius: 10px;
...
![WhatsApp Image 2025-11-25 at 16 35 04_d9cdbf20](https://github.com/user-attachments/assets/8e821cbf-a52b-4d37-baee-52fc6b66d669)
